...
export interface Room {
  ...
  cleaningReason?: string; // Motivo por el cual la habitación necesita ser limpiada (opcional)
  recleaningImageUrl?: string; // URL de la imagen para la relimpieza (opcional)
